...
(function (root, factory) {
  ...
  var VARIANTS = [
    ...
    { name: "紀錄法(上桿掃6位置,紀錄1/2/3全同)", opts: { predictMode: "records" } },
    { name: "紀錄法 回溯32次", opts: { predictMode: "records", steps: 32, spareRows: 48 } },
    { name: "紀錄法 回溯64次", opts: { predictMode: "records", steps: 64, spareRows: 80 } },
